...
// let str="Quality"
// let newstr = str.replace("Q","P")
// console.log(newstr)   //prob with this func is if small letters are there then it won't replace and viceversa
newstr=str.replace("q", "p")
console.log
