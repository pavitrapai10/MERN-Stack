...
//slice prints values from lhs to rhs, supports negative indexing
...
for(let t of arr){
    if(vowelArr.indexOf(t)>=0){  //if that character t is part of vowel arr means all elements from arr will be 
        //searched in vowerArr
        console.log(t)
    }
}
